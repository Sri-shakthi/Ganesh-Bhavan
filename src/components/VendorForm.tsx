...
export default function VendorForm({ googleFormId }: VendorFormProps) {
  ...
  return (
    <Card className="p-6 md:p-8 bg-white shadow-lg">
      ...
      <p className="text-gray-600 mb-6 text-base md:text-lg">
        Are you a vegetable vendor or grocery supplier? We would love to partner with you.
        Click the button below to fill out our Google Form.
      </p>
      <Button
        asChild
